...
sk dev push-image --name grabbill/grabbill-website-uat --registry docker.evos.tech --tag ${TAG_SUFFIX} $DRY_RUN
sk dev push-image --name grabbill/grabbill-client-uat --registry docker.evos.tech --tag ${TAG_SUFFIX} $DRY_RUN
sk dev push-image --name grabbill/grabbill-admin-uat --registry docker.evos.tech --tag ${TAG_SUFFIX} $DRY_RUN

 ...
 */
@Data
public class UserAccountPayload implements ApiPayload {
    ...
    public static UserAccountPayload from(final Account account) {
        UserAccountPayload instance = new UserAccountPayload();
        ...
        instance.logo = account.getLogo();
        instance.setSftpHost(account.getSftpHost());
        instance.setSftpPort(account.getSftpPort());
        instance.setSftpUsername(account.getSftpUsername());
        instance.setSftpPassword(account.getSftpPassword());

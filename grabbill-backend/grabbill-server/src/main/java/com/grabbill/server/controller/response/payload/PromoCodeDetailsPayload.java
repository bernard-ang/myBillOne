 ...
 */
@Data
public class PromoCodeDetailsPayload implements ApiPayload {
    ...
    public static PromoCodeDetailsPayload from(
            final PromoCode promoCode
    ) {
        PromoCodeDetailsPayload payload = new PromoCodeDetailsPayload();

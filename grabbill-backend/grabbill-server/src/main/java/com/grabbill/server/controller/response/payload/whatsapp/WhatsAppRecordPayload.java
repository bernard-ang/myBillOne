...
import com.grabbill.server.controller.response.payload.BaseRecordPayload;
import lombok.Data;
 ...
 */
@Data
public class WhatsAppRecordPayload extends BaseRecordPayload {
    ...
    void copyFrom(final WhatsAppRecord record) {
